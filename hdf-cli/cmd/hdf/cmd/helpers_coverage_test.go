...
// NOTE: unit tests for the query filter/glob helpers (compileSafeRegex,
// safeGlobMatch, parseImpactFilter, compareImpact, tagMatchesGlob,
// buildFilters) moved into hdf-engine/go/filter_test.go with the logic.
// ---------------------------------------------------------------------------
