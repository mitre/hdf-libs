...
require (
	...
	github.com/mitre/hdf-libs/hdf-converters/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-diff/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-generators/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-mappings/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-parsers/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-schema/dist/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-utilities/go/v3 v3.4.1
	github.com/mitre/hdf-libs/hdf-validators/go/v3 v3.4.1
