...
require (
	...
	github.com/mitre/hdf-libs/hdf-converters/v3 v3.1.1
	github.com/mitre/hdf-libs/hdf-diff/go/v3 v3.1.1
	github.com/mitre/hdf-libs/hdf-generators/go/v3 v3.1.1
...
require (
	...
	github.com/mitre/hdf-libs/hdf-mappings/go/v3 v3.1.1 // indirect
	github.com/mitre/hdf-libs/hdf-parsers/go/v3 v3.1.1 // indirect
