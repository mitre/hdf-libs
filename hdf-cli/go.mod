...
require (
	...
	github.com/mitre/hdf-libs/hdf-converters/v3 v3.4.3
	github.com/mitre/hdf-libs/hdf-diff/go/v3 v3.4.3
	github.com/mitre/hdf-libs/hdf-generators/go/v3 v3.4.3
