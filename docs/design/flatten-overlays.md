...
**Consumer Bug:** heimdall-enterprise-1s6 (P0 — 741 controls shown instead of 247)
**Based on:** 6 research agents analyzing inspecjs, hdf-libs, InSpec spec, real fixtures, algorithm options, and Vara consumption
...
8. **Wire into Vara** (separate card in heimdall-enterprise)
