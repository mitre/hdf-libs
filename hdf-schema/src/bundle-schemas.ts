...
const MAIN_SCHEMAS = ['hdf-results.schema.json', 'hdf-baseline.schema.json', 'hdf-comparison.schema.json', 'hdf-system.schema.json', 'hdf-plan.schema.json', 'hdf-amendments.schema.json'];
