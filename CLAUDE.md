...
- All Aesir apps use CCI mappings from hdf-mappings, not mitre/inspec-objects
...
Critical planning docs exist in the `aesirsystems/hdf-libs` fork on branch `hdf-schema`:
...
**Access**: https://github.com/aesirsystems/hdf-libs/tree/hdf-schema/docs/planning
...
- **Design Docs**: https://github.com/aesirsystems/hdf-libs/tree/hdf-schema/docs/planning
