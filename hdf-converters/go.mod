...
require (
	...
	github.com/mitre/hdf-libs/hdf-mappings/go/v3 v3.3.2
	github.com/mitre/hdf-libs/hdf-parsers/go/v3 v3.3.2
	github.com/mitre/hdf-libs/hdf-schema/dist/go/v3 v3.3.2
	github.com/mitre/hdf-libs/hdf-utilities/go/v3 v3.3.2
	github.com/stretchr/testify v1.11.1
)

require (
	github.com/davecgh/go-spew v1.1.1 // indirect
	github.com/mitre/hdf-libs/hdf-validators/go/v3 v3.3.2 // indirect
