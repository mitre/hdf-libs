...
func TestLegacyHdfFingerprint(t *testing.T) {
	fptest.RunFingerprintTests(t, fptest.FingerprintSpec{
		...
		Positive: []fptest.DetectionCase{
			{
				Name:       "detects HDF v1 structure at confidence 1.0",
		...
		Negative: []fptest.DetectionCase{
			{Name: "does not match when baselines array is present (HDF v2)", Input: map[string]any{"version": "2.0.0", "profiles": []any{}, "platform": map[string]any{"name": "ubuntu"}, "baselines": []any{}}},
