...
describe('Microsoft Defender for Cloud to HDF converter', async () => {
  describe('error handling', async () => {
    it('should throw on empty input', async () => {
      await expect(convertMsftDefenderCloudToHdf('')).rejects.toThrow();
    });

    it('should throw on invalid JSON', async () => {
      await expect(convertMsftDefenderCloudToHdf('not json')).rejects.toThrow();
    });
  ...
  describe('minimal fixture conversion', async () => {
    it('should produce valid HDF structure', async () => {
      ...
      expect(hdf.dataSource?.name).toBe('Microsoft Defender for Cloud');
