...
// MappingEntry is one adjudicated query-to-control mapping.
type MappingEntry struct {
	CCI  []string
	NIST []string
}

// KicsMappingData holds CCI + NIST mappings for KICS queries, keyed on
// query_id. TS peer: mapping-data.ts.
//
// # Mapping methodology
//
