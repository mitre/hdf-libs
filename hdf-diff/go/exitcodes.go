...
func ComputeBasicExitCode(summary ComparisonSummary) int {
...
func ComputeDetailedExitCode(summary ComparisonSummary) int {
	if !hasDifferences(summary) {
		return Identical
	}
...
func hasDifferences(summary ComparisonSummary) bool {
